...
public class StockPriceGeneratorService {
    ...
    public StockPriceGeneratorService() {
        //Initialize list of stock in a hashtable = dictionnary
        listStock = new Hashtable<>();

        StockPriceDto stock;

        // create an object stockPriceDto
        stock = new StockPriceDto("ACCOR","FR0000120404 AC",41.0,42.5);
        // put the stock object in the hashtable with the stock id as a key
    ...
    public StockPriceDto GenerateStock(String stockId){
        // get stockPriceDto from hashtable with the stockID
        ...
        //else caculate the stock open price
        ...
        // return the stockPriceDto
        return  stockPrice;
    }
    // generate a random value between min price and max price
    private Double GetRandomPrice(Double minPrice, Double maxPrice) {
        return minPrice + Math.random() * (maxPrice - minPrice);
    }
    // calculate the % between open price and price
