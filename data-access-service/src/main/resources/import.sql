...
INSERT INTO customers(id,address, birthday, email, firstname, lastname, phonenumber) VALUES (1, 'Choisy', '30/12/2000', 'tata@gmail.com', 'toto', 'tata', '0125487987');
...
--Data table account
INSERT INTO account(id, account_number, date, type, customer_id) VALUES (1,1, '2014/05/12', 'courant', 1);
...
INSERT INTO public.balance(id, balance, last_date_balance, account_id) VALUES (1, 300, '2014/05/12', 1);
